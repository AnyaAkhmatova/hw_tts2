...
class BaseTrainer:
    ...
    def __init__(self, generator, discriminator_mpd, discriminator_msd, criterion, optimizer, lr_scheduler, config, device):
        self.device = device
        self.config = config
    ...
    def _save_checkpoint(self, epoch, save_best=False, only_best=False):
        ...
        state = {
            ...
            "mpd_state_dict": self.discriminator_mpd.state_dict(),
            "msd_state_dict": self.discriminator_msd.state_dict(),
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        self.discriminator_mpd.load_state_dict(checkpoint["mpd_state_dict"])
        self.discriminator_msd.load_state_dict(checkpoint["msd_state_dict"])
